...
const outputFile = fse.outputFile;
 ...
 */
export default async function createProject(cwd, version, options = {}) {
	const name = "root-pkg";
	...
	await outputFile(_resolve(cwd, ".gitignore"), ["node_modules"].join("\n"), "utf-8");
